...
export default async function StatusPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">平台掃描狀態</h1>
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">各平台最近一次成功掃描時間與失敗紀錄</p>
      </div>
