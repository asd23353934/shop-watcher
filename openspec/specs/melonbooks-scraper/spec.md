# melonbooks-scraper Specification

## Purpose

Defines the scraping behavior for Melonbooks, a Japanese doujinshi and anime goods retailer. The scraper uses the `AUTH_ADULT=1` cookie to bypass age verification, fetches SSR HTML search results sorted by newest, and parses `.item-list li` elements.
