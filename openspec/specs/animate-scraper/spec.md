# animate-scraper Specification

## Purpose

Defines the scraping behavior for Animate Taiwan, a Japanese anime merchandise online shop. The scraper fetches search results via HTTP GET to the ASP.NET SSR HTML endpoint and returns structured `WatcherItem` objects.
