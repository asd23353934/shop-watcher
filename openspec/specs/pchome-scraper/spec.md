# pchome-scraper Specification

## Purpose

Defines the scraping behavior for PChome 24h (24h.pchome.com.tw), a major Taiwanese e-commerce platform. The scraper calls the official JSON search API and maps the `prods` array to `WatcherItem` objects.
