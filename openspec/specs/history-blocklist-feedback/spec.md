# history-blocklist-feedback Specification

## Purpose

Defines the quick-add-to-blocklist feedback capability on the notification history page. Users can append a word to a keyword's blocklist directly from a notification record without navigating away from the history page.
