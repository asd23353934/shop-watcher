# momo-scraper Specification

## Purpose

Defines the scraping behavior for MOMO購物 (momoshop.com.tw), a major Taiwanese e-commerce platform. The scraper fetches search results via HTTP GET and parses product data from the JSON-LD `ItemList` schema embedded in the SSR HTML response.
